...
import type { Settings, GeminiModel, GeminiVoice } from "../types/settings";

interface SettingsPanelProps {
  settings: Settings;
  onUpdate: <K extends keyof Settings>(key: K, value: Settings[K]) => Promise<void>;
  onClose: () => void;
}

const MODEL_OPTIONS: { value: GeminiModel; label: string }[] = [
  { value: "gemini-2.5-flash-native-audio-latest", label: "Gemini 2.5 Flash (latest)" },
  { value: "gemini-2.5-flash-native-audio-preview-12-2025", label: "Gemini 2.5 Flash (preview)" },
];
      ...
      <div style={panelStyle}>
        ...
        <div style={bodyStyle}>
          ...
          <div style={sectionStyle}>
            ...
            <p style={hintStyle}>
              有効にすると「CCに送信」時に pyautogui でCC画面にサマリーを自動入力します
            </p>
          </div>
        </div>
      </div>
